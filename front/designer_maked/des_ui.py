...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.playlistsGgroupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.playlistsGgroupBox.setObjectName("playlistsGgroupBox")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.playlistsGgroupBox)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.playlistScrollArea = QtWidgets.QScrollArea(self.playlistsGgroupBox)
        self.playlistScrollArea.setWidgetResizable(True)
        self.playlistScrollArea.setObjectName("playlistScrollArea")
        self.playlistScrollAreaWidget = QtWidgets.QWidget()
        self.playlistScrollAreaWidget.setGeometry(QtCore.QRect(0, 0, 350, 344))
        self.playlistScrollAreaWidget.setObjectName("playlistScrollAreaWidget")
        self.playlistScrollArea.setWidget(self.playlistScrollAreaWidget)
        self.verticalLayout_2.addWidget(self.playlistScrollArea)
        self.playlistsLayout.addWidget(self.playlistsGgroupBox)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.playlistsGgroupBox.setTitle(_translate("MainWindow", "Плейлисты"))
